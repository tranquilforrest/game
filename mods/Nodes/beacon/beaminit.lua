...
minetest.register_abm({
	...
	action = function(pos, node)
		minetest.add_particlespawner(
			...
			"beacon_blue_particle.png" --texture
		)
	end,
})
...
minetest.register_abm({
	...
	action = function(pos, node)
		minetest.add_particlespawner(
			...
			2, --maxsize
			false, --collisiondetection
			"beacon_red_particle.png" --texture
		)
	end,
})
...
minetest.register_abm({
	...
	action = function(pos, node)
		minetest.add_particlespawner(
			...
			2, --maxsize
			false, --collisiondetection
			"beacon_green_particle.png" --texture
		)
	end,
})
...
minetest.register_abm({
	...
	action = function(pos, node)
		minetest.add_particlespawner( --I actually borrowed this code from the nether mod
			...
			2, --maxsize
			false, --collisiondetection
			"beacon_purple_particle.png" --texture
		)
	end,
})