...
minetest.register_node("crafting:workbench", {
	...
	tiles = {
		"workbench_top.png", "workbench_bottom.png",
		{name = "workbench_side.png", tileable_vertical = false}
	},
	paramtype2 = "facedir",
...
crafting.create_async_station("crafting:furnace", "furnace", 1, {
	...
	groups = {oddly_breakable_by_hand=2, cracky=2, not_in_creative_inventory=1},
	legacy_facedir_simple = true,
	is_ground_content = false,
})
